...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/jobs/handling-records", label: "Job Handling Records", icon: "🗂️" },
  ...
  },
  {
    group: "Performance",
    items: [
      { href: "/goals/company", label: "Company Goal Centre", icon: "🏢", roles: ["SUPER_ADMIN", "MANAGEMENT"] },
      { href: "/goals/departments", label: "Department KPI Centre", icon: "🏬", roles: ["SUPER_ADMIN", "MANAGEMENT", "DEPARTMENT_HEAD", "HR_ADMIN"] },
      { href: "/goals/position-kpi", label: "Position KPI Setup", icon: "🎯", roles: ["SUPER_ADMIN", "MANAGEMENT", "HR_ADMIN"] },
      { href: "/results", label: "Result Centre", icon: "🏁" },
      ...
      { href: "/bonus-pool", label: "Team Bonus Pool", icon: "🎁" },
      { href: "/ai-performance-coach", label: "AI Performance Coach", icon: "🤖" },
      { href: "/ai-response-centre", label: "AI Response Centre", icon: "✉️" },
    ],
  },
  {
